...
Hi there! I'm **Faris**, a passionate developer and have a Math and Computer Science bachelor's degree at Faculty of Science and Mathematics, University of Sarajevo. I specialize in **web applications**, **game development**, and **software solutions**. This profile showcases my journey, projects, and skills. 🚀
...
###  🌐 **Web Site**
- **[BudgetFlo](https://github.com/GoodmanFaris/personal-finance-tracker)**: Free Online Open-source Personal Finance Tracker. ([Deployed](https://budgetflo.online))
...
- ### 🤖 **Intel six class Classification CNN**
- **[EmailPhissingAnalyzer ML]([https://github.com/GoodmanFaris/IntelSixClassCNN](https://github.com/GoodmanFaris/PhisingAnalyzer))**:  A phishing email detection system using TF-IDF vectorization and Logistic Regression to classify emails as legitimate or malicious.
